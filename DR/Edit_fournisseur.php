...
{ 
  ...
  $sql = "UPDATE fournisseur SET raison_sociale='$no',gerent='$ger', secteur='$sec', fix='$fix', tel='$tel', adresse='$adresse', email='$email' WHERE idfour=".$sid;
...
if(isset($_POST['save']))
{
  $sid=$_SESSION['edid'];
    ...
    $sql="UPDATE fournisseur SET imgefour='$img' WHERE idfour='$sid'";
    $query = $dbh->prepare($sql);
    $query->execute();
    if ($query->execute()) {
  ...
  <section class="content">
    <div class="container-fluid">
      <div class="row">
       ...
       $ret=mysqli_query($con,"select * from fournisseur where idfour=".$eid);
       $cnt=1;
           ...
           <div class="card card-primary card-outline">
            <div class="card-body box-profile">
              <div class="text-center">
                ...
                src="fournisseur_img/<?php echo $row['imgefour'] ?>" width="150" height="150" class="user-image"
