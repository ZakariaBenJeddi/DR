...
if (strlen($_SESSION['sid'] == 0)) {
  ...
  if (isset($_POST['submit'])) {
    ...
    $passerelle = trim(mysqli_real_escape_string($con, $_POST['passerelle'])); // Correction du nom
    ...
    if ($stmt->execute()) {
        echo "<script>alert('Le cours du jour a été ajouté avec succès.');</script>";
                    ...
                    <div class="card-body">
                      ...
                      <div class="row">
                        ...
                        <div class="form-group col-md-3">
                          ...
                          <input type="number" class="form-control" id="passerelle" name="passerelle" placeholder="Passerelle">
                        </div>
                      </div>
                      <hr>
                    </div>
