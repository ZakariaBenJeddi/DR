                        ...
                        ?>
                          <tr>
                            ...
                            <td><?php
                                ...
                                ?></td>
                            <td><a class="btn w-100  btn-sm <?php if ($row['payer'] == 1 || $row['facture'] != 1) {
                                                              if ($row['payer'] == 1) {
                                                                echo 'disabled btn-danger';
                                                              } else {
                                                                echo 'disabled btn-info';
                                                              }
                                                            } else {
                                                              echo ' btn-primary';
                                                            } ?>" onClick="return confirm('Etes-vous sûr que vous voulez payer cette facture?')" href="reste_payer_clx.php?payer=<?php echo $row['id_demande'] ?>"><?php if ($row['payer'] == 1) {
                                                                                                                                                                                                                                                                                                                                                                              echo '<small>Facture payée</small> ';
                                                                                                                                                                                                                                                                                                                                                                            } else {
                                                                                                                                                                                                                                                                                                                                                                              if ($row['facture'] == 1 and $row['payer'] == 0) {
                                                                                                                                                                                                                                                                                                                                                                                echo '<small>Payer</small>';
                                                                                                                                                                                                                                                                                                                                                                              } else {
                                                                                                                                                                                                                                                                                                                                                                                if ($row['payer'] == 0) {
                                                                                                                                                                                                                                                                                                                                                                                  echo '<small>Attend Validation</small>';
                                                                                                                                                                                                                                                                                                                                                                                }
                                                                                                                                                                                                                                                                                                                                                                              }
                                                                                                                                                                                                                                                                                                                                                                            } ?>
                              </a></td>
    ...
    function expo() {
      ...
      table.columns().every(function() {
        ...
        if (this.header().textContent != "#" && this.header().textContent != "Action" && this.header().textContent != "Besoin" && this.header().textContent != "B.command") {
          if (this.header().textContent == "Facture") {
            headers.push("Etat")
          } else {
