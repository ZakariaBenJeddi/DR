...
if(isset($_GET['del']))
{
  ...
  mysqli_query($con,"delete from ste where ids = '".$_GET['id']."'");
          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Gérer les sociétés</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Gérer les sociétés</h3>
                  <div class="card-tools">
                    <a href="Add_ste.php"><button type="button" class="btn btn-sm btn-primary"  ><span style="color: #fff;"><i class="fas fa-plus" ></i>&nbsp;société</span>
                    </button> </a>                  
                  </div>
                </div>
                <!-- /.card-header -->
                ...
                <div class="card-body mt-2 " >
                  ...
                  <table id="example1" class="table table-bordered table-hover">
                    ...
                    <tbody>
                      <?php $query=mysqli_query($con,"select * from ste");
                      $cnt=1;
                      while($row=mysqli_fetch_array($query))
                      {
                        ...
                        <tr>
                          ...
                          <td>
                            <button  class=" btn btn-primary btn-xs edit_data" id="<?php echo  $row['ids']; ?>" title="click for edit">Modifier</i></button>
                            <button  class=" btn btn-success btn-xs edit_data2" id="<?php echo  $row['ids']; ?>" title="click for edit">Voir</i></button>
                            <a href="List_ste.php?id=<?php echo $row['ids']?>&del=delete" onClick="return confirm('Etes-vous sûr que vous voulez supprimer?')" class=" btn btn-danger btn-xs ">Supprimer</a>
