...
if(isset($_GET['del']))
{
  ...
  mysqli_query($con,"truncate table rnd");
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">CALEDRIER</h3>
   ...
   $query=mysqli_query($con,"SELECT * FROM `rnd`");
                      ...
                      while($row=mysqli_fetch_array($query))
                      {
                        ...
                        <tr>
                          ...
                          <td class="align-middle"><?php echo htmlentities($row['sec']);?></td>
						  ...
						  <td><?php echo htmlentities($row['type_ex']);?></td>
						  <td><?php echo htmlentities($row['type_ep']);?></td>
							 <td><?php echo htmlentities($row['nbrv']);?></td>
							  <td><?php echo htmlentities($row['nbrs']);?></td>
							  <td><?php echo htmlentities($row['nbrj']);?></td>
