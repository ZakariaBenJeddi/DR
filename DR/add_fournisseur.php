...
if (strlen($_SESSION['sid']==0)) {
  ...
  if(isset($_POST['submit']))
  {
    ...
    $stmt = $con->prepare("INSERT INTO fournisseur (raison_sociale, adresse, secteur, gerent, email, tel, fix,imgefour) VALUES (?, ?, ?, ?, ?, ?, ? ,?)");
    $stmt->bind_param("ssssssss", $no, $adresse, $sec, $ger, $email, $tel, $fix ,$img);
    if ($stmt->execute()) {
      if(file_exists($chemin)){
        ...
        echo "<script>alert('Le fournisseur a été ajoutée.');</script>";
        echo "<script>window.location.href = 'List_fournisseur.php'</script>";
    } else {
            ...
            <div class="row mb-2">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item"><a href="List_fournisseur.php">Liste</a></li>
              ...
              <div class="col-md-12">
                ...
                <div class="card card-primary">
                  ...
                  <form role="form" method="post" enctype="multipart/form-data">
                    <div class="card-body">
                      <span style="color: brown"><h5>Détails fournisseur</h5></span>
                      <hr>
                      <div class="row">
                        ...
                        <div class="form-group col-md-3">
                          ...
                          <input type="text" class="form-control" id="age" name="ger" placeholder="....." required>
                        </div>
                        ...
                        <div class="form-group col-md-3">
                          ...
                          <input type="text" class="form-control" id="num" name="tel" placeholder="Tel" required>
                        </div>
                      
                        <div class="form-group col-md-3">
                          <label for="num">Fix</label>
                          <input type="text" class="form-control" id="num" name="fix" placeholder="Fix" required>
                        </div>
                        <div class="form-group col-md-3">
                          <label for="num">Image</label>
                          <input type="file" class="form-control" id="num" name="img" required>
                        </div>
                      </div>
                      <hr>
                    </div>
