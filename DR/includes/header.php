...
$nbr_orientation = 4;
if (count($messages) > 0 || count($messages_cdj) > 0) {
  $nbr_orientation = count($messages) + count($messages_cdj);
}
  ...
  <ul class="navbar-nav ml-auto">
    <li class="nav-item dropdown">
      <a class="nav-link dropdown-toggle" href="#" id="notification-link" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        <?php  $badge = '';
          // Affichage du badge selon le service
          ...
          } elseif ($_SESSION['service'] == "achat_dr" && $nbr > 0) {
            $badge = "<span class='position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger'>
                        $nbr
                      </span>";
          }
      ...
      <div class="dropdown-menu dropdown-menu-right" aria-labelledby="notification-link" id="noti">
        ...
        <p class="nott">
          <a href="<?php
                    ...
                    } elseif ($_SESSION['service'] == "achat_cmplx") {
                      echo "./notification_clx.php";
                    } elseif ($_SESSION['service'] == "orientation") {
                      echo "./notification_orientation.php";
                    }
                    ?>">
