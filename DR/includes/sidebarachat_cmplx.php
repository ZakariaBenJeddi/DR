  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item has-treeview menu-open">
          <a href="dash_achat_cmplx.php" class="nav-link active">
        ...
        <li class="nav-item">
          <a href="List_etablissement.php" class="nav-link">
        ...
        <li class="nav-item">
          <a href="list_fournisseur.php" class="nav-link">
        ...
        <li class="nav-item">
          <a href="liste_demande_prix_clx.php" class="nav-link">
          <!-- <i class="fas fa-puzzle-piece"></i> -->
        ...
        <li class="nav-item">
          <a href="reste_payer_clx.php" class="nav-link">
          <!-- <i class="fas fa-puzzle-piece"></i> -->
          <i class="price-icon fa fa-dollar-sign"></i>
            <p>
              Reste à payer
        ...
        <li class="nav-item">
          <a href="facture_payé_clx.php" class="nav-link">
          <!-- <i class="fas fa-puzzle-piece"></i> -->
          <i class="price-icon fa fa-dollar-sign"></i>
            <p>
              Facture payés
        ...
        <li class="nav-item">
          <a href="list_budget_complex.php" class="nav-link">
          <!-- <i class="fas fa-puzzle-piece"></i> -->
          <i class="price-icon fa fa-wallet"></i>
            <p>
            Gerer budget 
            </p>
          </a>
